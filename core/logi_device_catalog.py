...
LOGI_DEVICE_LAYOUTS = {
    ...
    "m720_triathlon": _layout(
        ...
        341,
        [
            # Coordinates are normalized to the CC BY photo (862x682, a
            # top-front three-quarter view). The scroll wheel sits upper-left;
            # the square gesture / app-switch button is just right of it; the
            # back/forward thumb buttons are on the near-left flank, forward of
            # the (non-remappable) 1-2-3 device-switch button.
            _hotspot(
                "middle",
                "Middle button",
                "mapping",
